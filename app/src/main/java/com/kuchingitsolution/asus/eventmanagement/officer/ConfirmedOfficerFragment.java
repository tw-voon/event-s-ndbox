...
public class ConfirmedOfficerFragment extends Fragment{
    ...
    public String TYPE = "CONFIRMED_OFFICER_LIST";
    ...
    public void get_confirmed_list(){
        ...
        getOfficerAsync.execute(Config.GET_OFFICER_LIST);
    }
...
//            showMessage(data);
    ...
    private void parse_result(String result){
        ...
        try {
            ...
            JSONArray info = all_data.optJSONArray("officer");
